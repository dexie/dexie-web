...
> **Status:** The Dexie Cloud SDK is currently in beta. Install with `npm install dexie-cloud-sdk@beta`.
> Blob handling features require Dexie Cloud Server **3.0.0** or later.
